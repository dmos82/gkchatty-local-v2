...
// Check if we're in SQLite-only mode
...
export const connectDB = async () => {
  // Skip MongoDB connection if using SQLite
  if (USE_SQLITE) {
    log.info('✅ Skipping MongoDB connection (USE_SQLITE=true)');
    return;
  }
