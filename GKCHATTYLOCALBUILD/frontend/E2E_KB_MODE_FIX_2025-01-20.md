...
> "from a user perspective, im able to query the chat just fine in gkchatty on local host 6004. is it possible you are selecting the correct toggle for the queries hybrid/my docs/ and system kb? also there arent any documents in the system kb"
