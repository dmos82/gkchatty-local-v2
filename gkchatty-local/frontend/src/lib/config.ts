...
/**
 * Get API base URL with runtime hostname detection for mobile support
 * Use this in client-side code instead of API_BASE_URL_CLIENT for mobile compatibility
 *
 * @returns API base URL - uses network IP when accessed from mobile, localhost otherwise
 */
export function getApiBaseUrl(): string {
  if (typeof window === 'undefined') {
    // Server-side: use the static server URL
